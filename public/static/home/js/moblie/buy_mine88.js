...
//		    updateMoneyRate();
        ...
        $("#stop-loss_ul > a").on('tap',function(e){
            ...
            //总计
            var total= ly+parseInt($("#publicFee>span").html()); //总金
            $('#total').html(total);
//			//递延条件
...
//     $.ajax({
//         type:"get",
//         url:"./index/Alistock/getCodeByKeyWords",
//         data:{code:code},
//         dataType:'json',
//         success:function(data){
// 			alert('chenggong');
...
$("#buy_number").off('keyup').on('keyup',function(){
 ...
 $("#stop-loss_ul>a:eq(2)").html(price * -1700);
 //交易综合费
 $("#publicFee>span").html((price * publicFee).toFixed(2) );
 //递延费
 //$("#delay_fee").html(price * delayFee);
...
$(function () {
    if($("#buy_number").val()!=""){
        ...
        $("#check-surplus_ul>a").html(price1 * 5000);
        ...
        //交易综合费
        $("#publicFee>span").html((price1 * publicFee).toFixed(2) );
    }
})
